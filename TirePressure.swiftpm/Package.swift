...
var package = Package(
    ...
    products: [
        .iOSApplication(
            name: "TirePressureApp",
            targets: ["AppModule"],
            bundleIdentifier: "com.colemancda.TPMS",
    ...
    dependencies: [
        .package(url: "https://github.com/MillerTechnologyPeru/TPMS.git", "0.1.0"..<"1.0.0"),
    ...
    targets: [
        .executableTarget(
            name: "AppModule",
            dependencies: [
                .product(name: "TPMS", package: "TPMS"),
